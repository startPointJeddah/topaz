                ...
                <div class="col-md-4 my-2 my-sm-2">
                    <div class="box">
                        ...
                        <div class="title">
                            ...
                            <a target="_blank" href="album.php?p=<?php echo $projectName ?>&b=<?php echo $buildingName ?>&B=1">
                            <button class="btn-box my-3 px-5 py-2" href="album.php?p=<?php echo $projectName ?>&b=<?php echo $buildingName ?>">عرض الصور</button>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 my-2 my-sm-2">
                    <div class="box">
                        ...
                        <div class="title">
                            ...
                            <a target="_blank" href="album.php?p=<?php echo $projectNumber ?>&b=<?php echo $buildingNumber ?>&B=2">
                                <button class="btn-box my-3 px-5 py-2" href="album.php?p=<?php echo $projectNumber ?>&b=<?php echo $buildingNumber ?>">عرض الصور</button>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 my-2 my-sm-2">
                    <div class="box">
                        ...
                        <div class="title">
                            ...
                            <a target="_blank" href="album.php?p=<?php echo $projectNumber ?>&b=<?php echo $buildingNumber ?>&B=3">
                                <button class="btn-box my-3 px-5 py-2" href="album.php?p=<?php echo $projectNumber ?>&b=<?php echo $buildingNumber ?>">عرض الصور</button>
                            </a>
                        </div>
                    </div>
